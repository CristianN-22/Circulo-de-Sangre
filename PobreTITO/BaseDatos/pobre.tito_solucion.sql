...
--
-- Host: localhost    Database: pobre.tito
-- ------------------------------------------------------
...
CREATE TABLE `solucion` (
  ...
  `IdReclamo` int DEFAULT NULL,
  `Estado` varchar(45) DEFAULT NULL,
  `FechaSolucion` varchar(45) DEFAULT NULL,
  `Comentario` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`IdSolucion`),
  KEY `idreclamo_idx` (`IdReclamo`),
  CONSTRAINT `idreclamo` FOREIGN KEY (`IdReclamo`) REFERENCES `reclamo` (`IdReclamo`)
...
-- Dump completed on 2022-11-04  6:17:25
